...
const Section4 = () => {
    return (
        <div className='pt-14 md:pt-30 main-container bg-[#080808] text-white'>
                    ...
                    <div className='mt- flex flex-col gap-10'>
                        ...
                        <div className='flex flex-col gap-6'>
                            ...
                            <div className='flex flex-col gap-1'>
                                ...
                                <p className='lg:max-w-[500px] text-[#FFFFFF80]'>We combine technology and creativity to build future-ready solutions that help businesses thrive in a competitive landscape.</p>
                            </div>
                        ...
                        <div className='flex gap-3 items-center'>
                            ...
                            <button className='py-2.5 px-4.5 bg-gradient-to-b from-[#521ED6] to-[#7E56E2] 
