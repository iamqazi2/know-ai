...
import { Zap, Link, Globe, Users, Bot, Cpu } from "lucide-react";

const BrandCards = () => {
  return (
    <div
      className="relative w-full max-w-[397px] mx-auto rounded-[20px] border border-gray-700 flex flex-col items-center px-5 py-4 overflow-hidden"
      style={{
        background:
    ...
    >
      ...
      <div className="flex justify-center gap-4 mb-2">
        {[Zap, Link, Globe, Users, Bot, Cpu].map((Icon, i) => (
          <div
            key={i}
            className="bg-black/40 border-[1px] border-white/20 backdrop-blur-2xl rounded-full w-[40px] h-[40px] flex items-center justify-center"
          >
