      ...
      >
        <div className="bg-blackbackdrop-blur-sm  rounded-3xl p-2 shadow-card hover:shadow-glow transition-all duration-700 relative overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-h-full md:max-h-[340px] relative z-10">
            ...
            <div className="py-6 px-4 sm:px-6 border border-white/20 rounded-3xl h-fit md:h-[327px]">
              {/* Year and Title */}
            ...
            <div className="md:col-span-2">
              <div className="grid grid-cols-2 gap-2">
                {images.map((image, imageIndex) => (
                  <motion.div
                    key={imageIndex}
                    className="aspect-square w-full max-h-[200px] sm:max-h-[240px] md:max-h-[327px] bg-muted/50 rounded-3xl overflow-hidden border border-border/30 group-hover:border-primary/30 transition-all duration-500"
